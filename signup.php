...
<div class="container-fluid login-container rounded shadow">
  ...
  <div class="form-group">
      ...
      <input type="text" class="form-control  <?php if (!empty($error_message)) echo 'error-input'; ?>" name="firstname" placeholder="Enter First Name">
    </div>
    <div class="form-group">
      <label for="username">Last Name:</label>
      <input type="text" class="form-control  <?php if (!empty($error_message)) echo 'error-input'; ?>" name="lastname" placeholder="Enter Last Name">
    </div>
  <div class="mb-3">
